...
export default function ConfiguracoesAluno() {
  return (
    <div>
      ...
      <div className="bg-white border border-ink/[0.07] rounded-xl shadow-soft p-5 max-w-lg mb-5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="font-serif text-lg text-ink">Entrar em outra turma</h2>
        </div>
